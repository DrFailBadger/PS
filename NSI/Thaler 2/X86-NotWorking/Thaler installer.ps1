...
$ThalerInstallDirectory = "C:\Program Files\Thaler\Thaler 3.1.0.3"
...
$registryPath = "Registry::HKEY_LOCAL_MACHINE\Software\Callataÿ & Wouters\Thaler"
...
$AppPathREg = "Registry::HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\App Paths\Thaler.exe"
...
$TargetPSExe = "$ThalerInstallDirectory\ThalerIII.exe"
$ShortcutFile = "$ShortCutPath\Enterprise Applications\Thaler v3 ($ThalerENV).lnk"
